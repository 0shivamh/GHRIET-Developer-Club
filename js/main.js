$(document).ready(function(){
    ...
    $(window).scroll(function(){
        ...
        if((pos_top>5) && (pos_top<50)){
            ...
            document.getElementById('navBar').classList.add('animate__animated','animate__fadeInDown','cnav')
            
        }
        else if((pos_top==0)){
            document.getElementById('navBar').classList.remove('animate__animated','animate__fadeInDown','cnav')
        }
